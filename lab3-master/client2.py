...
def encoder(text):
    ...
    for a in text:
        ...
        # якщо буква то
        if range_ in range(97, 123) or range_ in range(1072, 1104) or range_ in range(65, 91) or range_ in range(1040,
                                                                                                                 1072) or range_ == "1168" or "1169" or "1028" or "1108" or "1031" or "1111":  ###IMPORTANT NOTE:
...
def decoder(text):
    ...
    for a in text:
        ...
        # якщо буква то
        if range_ in range(97, 122) or range_ in range(1072, 1103) or range_ in range(65, 90) or range_ in range(1040,
                                                                                                                 1071) or range_ == "1168" or "1169" or "1028" or "1108" or "1031" or "1111":  ###FOR LAST RANGE AND
